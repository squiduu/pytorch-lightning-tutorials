    ...
    for slot in slots:
        if slot in label_dict.keys():
            ...
            if (
                ...
                and label_dict[slot] in ["gastropub", "la raza", "galleria", "gallery", "science", "m"]
                or "area" in slot
            ...
            if (
                ...
                and label_dict[slot] in ["stansted airport", "cambridge", "silver street"]
                or slot == "attraction-area"
                and label_dict[slot] in ["norwich", "ely", "museum", "same area as hotel"]
            ):
                label_dict[slot] = "none"
...
def has_or_character(slot_values: Dict[str, str]):
